*&---------------------------------------------------------------------*
*& Report ZMLA_DEMO_GUI_ALV_GRID_02
*&---------------------------------------------------------------------*
*& ALV-Grid: Im Selektionsbild anzeigen,
*& Datenausgabe in editierbarem ALV-Grid darstellen,
*& Standard-Button „Refresh“ abfangen, kein zusätzliches Dynpro
*&---------------------------------------------------------------------*
REPORT zmla_demo_gui_alv_grid_02.
