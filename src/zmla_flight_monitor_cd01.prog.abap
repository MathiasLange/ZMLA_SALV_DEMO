...
CLASS lcl_persistency_layer DEFINITION.
  ...
  PUBLIC SECTION.
    METHODS: constructor,
             get_data EXPORTING et_output_data TYPE gty_t_output_data.
  PRIVATE SECTION.
...
CLASS lcl_model DEFINITION INHERITING FROM zcl_bc_model.
  ...
  PUBLIC SECTION.
    DATA: mo_persistency_layer TYPE REF TO lcl_persistency_layer,
          mt_output_data       TYPE gty_t_output_data.
...
CLASS lcl_selections DEFINITION.
  PUBLIC SECTION.
    DATA: s_carrid  TYPE RANGE OF sflight-carrid,
